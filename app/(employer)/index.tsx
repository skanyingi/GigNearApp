...
export default function EmployerDashboard() {
  ...
  const [boostJob, setBoostJob] = useState<string | null>(null);
  ...
  <View style={styles.cardActions}>
    <TouchableOpacity style={styles.boostBtn} onPress={() => setBoostJob(job.title)}>
      <Ionicons name="flash" size={13} color="#fff" />
      <Text style={styles.boostBtnText}>Boost with M-Pesa</Text>
    </TouchableOpacity>
    <TouchableOpacity>
...
boostBtnText: { fontSize: 12, fontWeight: "700", color: "#fff" },
});
